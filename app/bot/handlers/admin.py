...
async def process_admin_statistics_command(message: Message, conn: AsyncConnection, i18n: dict[str, str]):
    try:
        ...
        if not statistics:
            await message.answer(text=i18n.get("statistics").format("Нет данных"))
            return
        ...
        await message.answer(text=i18n.get("error_occurred", "Произошла ошибка при получении статистики"))
